...
namespace MvcUp1_Data.Migrations
{
    ...
    [Migration("20211027042305_InquiryHeaderAndInquiryDetail")]
    partial class InquiryHeaderAndInquiryDetail
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MvcUp1_Model.InquiryDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MvcUp1_Model.InquiryHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MvcUp1_Model.InquiryDetail", b =>
                {
                    b.HasOne("MvcUp1_Model.InquiryHeader", "InquiryHeader")
                        .WithMany()
                        .HasForeignKey("InquiryHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MvcUp1_Model.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("MvcUp1_Model.InquiryHeader", b =>
                {
                    b.HasOne("MvcUp1_Model.ApplicationUser", "ApplicationUser")
                        .WithMany()
